    ...
    <div class="form-box login">
        ...
        <form id="clienteLoginForm" autocomplete="on">
            ...
            <div class="input-box animation" style="--i:2;">
                <input type="password" id="pass_cliente" name="clave" required autocomplete="current-password">
            ...
            <div class="form-scroll-container animation" style="--i:18;">
                ...
                <div class="input-box">
                    <div style="display:flex; gap:8px; align-items:center;">
                        <select name="tipo_cedula" id="tipo_cedula" style="width:55px; background:transparent; color:inherit; border:none; border-bottom:2px solid #0ef; padding:5px; outline:none; height:40px;">
                            <option value="V" style="color:#000;">V</option>
                            <option value="E" style="color:#000;">E</option>
                            <option value="J" style="color:#000;">J</option>
                            <option value="P" style="color:#000;">P</option>
                        </select>
                        <input type="text" id="cedula" name="cedula" required style="flex:1; background:transparent; border:none; outline:none; color:inherit; border-bottom:2px solid #0ef; padding:5px 10px; height:40px;" autocomplete="off">
                    </div>
                ...
                <div class="input-box">
                    <select id="sexo" name="sexo" style="width:100%; background:transparent; border:none; border-bottom:2px solid #0ef; color:inherit; padding:8px 0; outline:none;">
                        <option value="" disabled selected style="color:#000;">Seleccione su sexo</option>
                ...
                <div class="input-box">
                    ...
                    <i class='bx bx-show toggle-password' id="toggleClave" style="cursor:pointer; position: absolute; right: 10px; top: 50%; transform: translateY(-50%); z-index: 99;"></i>
                </div>
                ...
                <div class="input-box">
                    ...
                    <i class='bx bx-show toggle-password' id="toggleConfirmar" style="cursor:pointer; position: absolute; right: 10px; top: 50%; transform: translateY(-50%); z-index: 99;"></i>
                </div>
        ...
        <div id="sectionRestablecer" style="display: none;">
            ...
            <form id="formRestablecerClave" autocomplete="off">
                ...
                <div class="input-box animation" style="--i:2;">
                    ...
                    <i class='bx bx-show toggle-password' id="toggleNuevaClave" style="cursor:pointer; position: absolute; right: 10px; top: 50%; transform: translateY(-50%); z-index: 99;"></i>
                </div>
                ...
                <div class="input-box animation" style="--i:3;">
                    ...
                    <i class='bx bx-show toggle-password' id="toggleRepetirClave" style="cursor:pointer; position: absolute; right: 10px; top: 50%; transform: translateY(-50%); z-index: 99;"></i>
                </div>
