...
<head>
    ...
    <style>
        ...
        .dashboard-body { background-color: #e9ecef !important; border-radius: 0 0 10px 10px; }
...
<div class="main-content">
    ...
    <div class="card shadow">
        ...
        <div id="statsSection" class="collapse show">
            <div class="card-body dashboard-body">
                <div class="row g-3">
                    <div class="col-md-3">
                        <div class="card text-white bg-danger shadow stats-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="card-title">Pagos Pendientes</h6>
                                        <h2 class="mb-0" id="pendientesCount"><?= $stats['pendientes'] ?? 0 ?></h2>
                                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card text-white bg-success shadow stats-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="card-title">Aprobados x Despachar</h6>
                                        <h2 class="mb-0" id="aprobadosCount"><?= $stats['aprobados'] ?? 0 ?></h2>
                                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card text-white bg-warning shadow stats-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="card-title">Despachos en Ruta</h6>
                                        <h2 class="mb-0" id="rutaCount"><?= $stats['en_ruta'] ?? 0 ?></h2>
                                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card text-white bg-dark shadow stats-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="card-title">Total Pedidos</h6>
                                        <h2 class="mb-0" id="totalPedidosCount">-</h2>
                                    </div>
    ...
    <!-- SECCIÓN 2: PENDIENTES POR APROBAR -->
    <div class="card shadow">
                                ...
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        ...
                                        <p class="mb-1 text-muted small">
                                            <i class="fas fa-user"></i> <?= htmlspecialchars($p['nombre_cliente']) ?><br>
                                            <i class="fas fa-phone"></i> <?= $p['telefono_cliente'] ?>
                                        </p>
                                    ...
                                    <div>
                                        <button class="btn btn-success btn-sm mb-1" onclick="aprobarPago(<?= $p['id_reporte'] ?>, <?= $p['id_pedido'] ?>)">
                                            <i class="fas fa-check"></i> Aprobar
                                        </button>
                                        <button class="btn btn-danger btn-sm" onclick="rechazarPago(<?= $p['id_reporte'] ?>)">
    ...
    <!-- SECCIÓN 3: APROBADOS PENDIENTES DE DESPACHO -->
    <div class="card shadow">
        ...
        <div id="aprobadosSection" class="collapse show">
            <div class="card-body dashboard-body" style="max-height: 400px; overflow-y: auto;">
                ...
                <?php else: ?>
                    <?php foreach ($pagos_aprobados as $p): ?>
                            ...
                            <div class="card-body py-2">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        ...
                                        <p class="mb-1 small"><strong>Total:</strong> $<?= number_format($p['total'], 2) ?></p>
                                    </div>
                                    <div>
                                        <button class="btn btn-primary btn-sm" onclick="mostrarFormularioDespacho(<?= $p['id_reporte'] ?>, <?= $p['id_pedido'] ?>, '<?= $p['cedula_persona'] ?>', '<?= htmlspecialchars($p['nombre_cliente'] ?? '') ?>', '<?= $p['telefono_cliente'] ?? '' ?>', '<?= htmlspecialchars($p['direccion_entrega'] ?? '') ?>')">
    ...
    <!-- SECCIÓN 4: ESTADÍSTICAS CON HIGHCHARTS -->
    <div class="card shadow">
        ...
        <div id="estadisticasSection" class="collapse show">
            <div class="card-body dashboard-body">
                <div class="row g-3">
                    <div class="col-md-4">
                        <div id="chartVentasDiarias" style="height: 280px;"></div>
                    </div>
                    <div class="col-md-4">
                        <div id="chartVentasMensuales" style="height: 280px;"></div>
                    </div>
                    <div class="col-md-4">
                        <div id="chartVentasNoConcretadas" style="height: 280px;"></div>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-12">
                        <div id="chartDespachosMensuales" style="height: 280px;"></div>
                    </div>
                </div>
            </div>
        </div>
