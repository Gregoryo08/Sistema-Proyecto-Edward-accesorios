...
class recuperacion 
{
    ...
    public function validarTokenYRestablecerClave()
    {
        ...
        try {
            ...
            $stmt_select = $conexUsuario->prepare("SELECT cedula_usuario, reset_token_expires_at FROM usuarios WHERE reset_token = :token");
            ...
            $stmt_update = $conexUsuario->prepare("UPDATE usuarios SET clave = :clave, reset_token = NULL, reset_token_expires_at = NULL WHERE cedula_usuario = :cedula");
            $stmt_update->execute([
                ":clave" => $hashed_clave,
    ...
    public function validarTokenExistente()
    {
        ...
        try {
            $conexUsuario = new Conexion("usuario");
            $stmt = $conexUsuario->prepare("SELECT cedula_usuario, reset_token_expires_at FROM usuarios WHERE reset_token = :token");
