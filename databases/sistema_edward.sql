...
--
-- Host: localhost    Database: sistema_edward
-- ------------------------------------------------------
...
INSERT INTO `bancos` VALUES (1,'Provincial','23423423423423',435345345,'04525673456','activo','2026-04-13 03:59:39'),(2,'Mercantil','423423499',563456743,'04893451234','activo','2026-04-13 04:01:47'),(3,'Banco de Venezuela','01020202154578963784',44445698,'04141234567','activo','2026-05-21 20:30:16'),(4,'Banco Mercantil','01050123456789012345',44445698,'04141234568','activo','2026-05-21 20:30:16'),(5,'Banco Provincial','01080123456789012345',44445698,'04141234569','activo','2026-05-21 20:30:16'),(6,'Banco Banesco','01340123456789012345',44445698,'04141234570','activo','2026-05-21 20:30:16'),(7,'Banco Nacional de Crédito','01910123456789012345',44445698,'04141234571','activo','2026-05-21 20:30:16'),(8,'Banco Bicentenario','01750123456789012345',44445698,'04141234572','activo','2026-05-21 20:30:16'),(9,'Banco del Tesoro','01630123456789012345',44445698,'04141234573','activo','2026-05-21 20:30:16'),(10,'Banco Plaza','01380123456789012345',44445698,'04141234574','activo','2026-05-21 20:30:16'),(11,'Banco Activo','01900123456789012345',44445698,'04141234575','activo','2026-05-21 20:30:16'),(12,'Banco Caroní','01280123456789012345',44445698,'04141234576','activo','2026-05-21 20:30:16');
...
--
-- Table structure for table `detalles_financiamiento`
--
...
--
-- Dumping data for table `detalles_financiamiento`
--
...
--
-- Table structure for table `detalles_servicio_tecnico`
--
...
--
-- Dumping data for table `detalles_servicio_tecnico`
--
...
--
-- Table structure for table `observaciones_turno`
--
...
--
-- Dumping data for table `observaciones_turno`
--
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_pedido_aprobado_a_venta` AFTER UPDATE ON `pago_online` FOR EACH ROW BEGIN
    ...
    IF NEW.estado_verificacion = 'aprobado' AND OLD.estado_verificacion != 'aprobado' THEN
        ...
        INSERT INTO ventas (
            ...
            origen_venta,
            total,
            cedula_persona,      -- ✅ Cliente que compró
            cedula_usuario,      -- ✅ Usuario que atendió (cajera)
            id_pedido            -- ✅ Relación con pedido
        ) VALUES (
            NOW(),
            'ecommerce',
            (SELECT total FROM pedidos WHERE id_pedido = NEW.id_pedido),
            NEW.cedula_persona,  -- ✅ CORREGIDO: usa cedula_persona
            NEW.verificado_por,  -- ✅ Cajera que aprobó
            NEW.id_pedido
        );
...
CREATE TABLE `pedidos` (
  ...
  `verificado_por` varchar(20) DEFAULT NULL COMMENT 'Cédula de la cajera que aprobó el pago',
...
--
-- Table structure for table `perfiles_financiamiento`
--
...
--
-- Dumping data for table `perfiles_financiamiento`
--
...
INSERT INTO `productos` VALUES (9,'Iphone 17',NULL,'usado sin rayones','iphone17.jpg',26,1,0,1,1,1020.00,1),(10,'Xiaomi Redmi Note 13',NULL,'Smartphone 8GB RAM, 128GB','xiaomi_redmi13.jpg',26,1,0,0,1,320.00,1),(11,'Samsung Galaxy A54',NULL,'256GB, pantalla 6.4','samsung_a54.jpg',26,1,0,0,1,450.00,1),(12,'AirPods Pro 2',NULL,'Audífonos inalámbricos','airpods_pro2.jpg',24,1,0,0,15,180.00,1),(13,'Cargador Rápido 33W',NULL,'USB-C carga rápida','cargador_rapido_33w.jpg',24,1,0,0,50,25.00,1),(14,'Funda Silicona iPhone 17',NULL,'Funda protectora','funda_silicona_iphone_17.jpg',24,1,0,0,29,15.00,1),(15,'Cargador 20W',NULL,'Cargador rápido USB-C 20W','cargador_20w.jpg',24,1,0,0,50,18.99,1),(16,'Cable USB-C',NULL,'Cable USB-C a USB-C 1m','cable_usbc.jpg',24,1,0,0,100,8.99,1),(17,'Enchufe Inteligente',NULL,'Enchufe WiFi compatible Alexa','enchufe_inteligente.jpg',22,1,0,0,29,25.99,1),(18,'Kit de Limpieza',NULL,'Kit completo para celulares','kit_limpieza.jpg',24,1,0,0,40,12.99,1),(19,'Lámpara LED',NULL,'Lámpara inteligente RGB','lampara_led.jpg',22,1,0,0,25,28.99,1),(20,'Parlante Bluetooth',NULL,'Parlante portátil 10W','parlante_bt.jpg',22,1,0,0,20,45.99,1),(21,'Soporte Auto',NULL,'Soporte magnético para auto','soporte_auto.jpg',24,1,0,0,60,15.99,1),(22,'Raton',NULL,'Raton nuevo','raton.jpg',24,2,2,10,3,10.00,1),(23,'Iphone xs max',NULL,'86% bateria','iphone_xs_max.jpg',26,1,0,1,1,180.00,1),(25,'Cargador de iphone',NULL,'carga rapida','cargador_de_iphone.jpg',24,1,5,10,1,10.00,1),(27,'Pantalla oled iphone',NULL,'Pantalla nueva','pantalla_oled_iphone.jpg',27,3,2,10,5,20.00,1),(28,'Iphone 17 pro',NULL,'memoria 500gb','iphone_17_pro.jpg',26,1,0,1,1,0.00,1),(29,'Discossd',NULL,'Disco ssd 250 gb para laptop y cpu','discossd.jpg',24,2,5,15,5,35.00,1),(30,'Discossd Grande',NULL,'Disco ssd 500 gb para laptop y cpu','discossd_grande.jpg',24,2,5,15,5,45.00,1);
...
--
-- Table structure for table `reservas_stock_temporal`
--
...
--
-- Dumping data for table `reservas_stock_temporal`
--
...
--
-- Table structure for table `servicio_productos`
--
...
--
-- Dumping data for table `servicio_productos`
--
...
--
-- Table structure for table `unidades_telefonos`
--
...
--
-- Dumping data for table `unidades_telefonos`
--
...
CREATE TABLE `ventas` (
  ...
  `id_pedido` int(11) DEFAULT NULL COMMENT 'ID del pedido que generó esta venta',
