...
?>
<?php require_once('assets/comunes/modalCargos.php'); ?>
        ...
        <div>
            ...
            <div class="table-responsive">
                <div class="table-container">
                    <table id="tablaCargos" class="table table-striped table-bordered text-center">
...
<script src="assets/js/validaciones/cargos/cargos.js"></script>
<script src="assets/js/validaciones/cargos/cargos2.js"></script>
