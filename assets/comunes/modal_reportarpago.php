    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php $pasos_modal = (($metodo ?? 'transferencia') === 'pago_movil') ? 4 : 3; ?>
                <form id="form-reporte" autocomplete="off">
                    ...
                    <div id="paso1" class="paso">
                        <h5 class="text-primary">Paso 1 de <?= $pasos_modal ?></h5>
                    ...
                    <div id="paso2" class="paso" style="display:none;">
                        <h5 class="text-primary">Paso 2 de <?= $pasos_modal ?></h5>
                    ...
                    <?php if (($metodo ?? 'transferencia') === 'pago_movil'): ?>
                    <div id="paso3" class="paso" style="display:none;">
                        <h5 class="text-primary">Paso 3 de <?= $pasos_modal ?></h5>
                    ...
                    <div id="paso4" class="paso" style="display:none;">
                        <h5 class="text-primary">Paso <?= $pasos_modal ?> de <?= $pasos_modal ?></h5>
                    ...
                    <div id="resumen" style="display:none;">
                        ...
                        <div class="card bg-light mb-3"><div class="card-body"><ul class="list-unstyled mb-0"><li><strong>📋 Referencia:</strong> <span id="r_ref"></span></li><li><strong>🏦 Banco:</strong> <span id="r_banco"></span></li><?php if (($metodo ?? 'transferencia') === 'pago_movil'): ?><li><strong>📱 Teléfono:</strong> <span id="r_telf"></span></li><?php endif; ?><li><strong>💵 Monto:</strong> <span id="r_monto"></span></li></ul></div></div>
