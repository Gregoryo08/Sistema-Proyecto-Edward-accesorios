            ...
            <form id="formRegistroEspecialidad">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <p id="mensajeEspecialidad" class="text-danger small" style="display: none; margin: 0;"></p>
                    </div>
                </div>
            ...
            <form id="formModificarEspecialidad">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <p id="mensajeEspecialidadModificar" class="text-danger small" style="display: none; margin: 0;"></p>
                    </div>
                </div>
                <div class="modal-footer">
