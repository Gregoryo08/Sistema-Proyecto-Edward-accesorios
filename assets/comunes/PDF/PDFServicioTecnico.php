...
<td style="width: 64%;"><h1>Reporte de Servicio Técnico</h1><p class="razon">EGC ACCESORIOS, CA. | RIF J-50318361-6</p><p class="ubicacion">Calle 25 esquina carrera 22, Centro Comercial Cosmos, nivel mesanina, local N° 8, Barquisimeto, Estado Lara.</p></td>
<td class="meta" style="width: 25%;"><strong>Fecha de emisión</strong><br><?= date('d-m-Y') ?><br><strong>Sistema Administrativo</strong></td>
</tr></table>
<h2 class="titulo-reporte">Detalle de servicios registrados</h2>
<p class="subtitulo">Listado generado con los filtros seleccionados.</p>
<?php if (!empty($data_to_pdf)): ?>
<table>
<thead><tr><th>ID</th><th>Cédula</th><th>Cliente</th><th>Equipo</th><th>Falla</th><th>Especialidad</th><th>Estado</th><th>Monto</th><th>Fecha</th></tr></thead>
<tbody>
...
<td><?= htmlspecialchars($row['equipo_descripcion'] ?? '') ?></td>
<td><?= htmlspecialchars($row['falla_inicial'] ?? '') ?></td>
...
<?php else: ?><p class="no-data">No se encontraron servicios con los filtros seleccionados.</p><?php endif; ?>
</body>
</html>
