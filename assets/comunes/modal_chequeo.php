<div class="modal fade" id="modalProcesarSolicitud" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" style="color: white; border: 1px solid #333;">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6  bg-white" style="background-color: white;">
                        <h6 class="text-primary mb-3 bg-white">Resumen de Productos</h6>
                        <div id="lista_productos_solicitud" class="mb-3 bg-white" style="background-color: white;"></div>
                    ...
                    <div class="col-md-6">
                        ...
                        <form id="formConfirmarVenta">
                            ...
                            <div class="mb-3">
                                <label class="form-label text-black-50">Tipo de Entrega / Tracking</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label text-black-50">Nota Adicional de Envío</label>
