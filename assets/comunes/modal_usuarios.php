            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-1">
                        <select class="form-select" id="prefijo" name="prefijo" style="max-width: 80px;">
                            <option value="V-">V-</option>
                            <option value="E-">E-</option>
                        </select>
                        <input type="text" class="form-control" id="cedula" name="cedula" placeholder="1234567" required>
                    </div>
                    <p id="msg_cedula" class="mensaje-error-usr"></p>

                    <label for="clave" class="form-label mt-2">Contraseña</label>
                    <input type="password" class="form-control mb-1" id="clave" name="clave" placeholder="Clave" required>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control mb-1" id="nombre" name="nombre" placeholder="Nombre" required>
                    <p id="msg_nombre" class="mensaje-error-usr"></p>

                    <label class="form-label mt-2">Apellido</label>
                    <input type="text" class="form-control mb-1" id="apellido" name="apellido" placeholder="Apellido" required>
                    <p id="msg_apellido" class="mensaje-error-usr"></p>

                    <label class="form-label mt-2">Correo Electrónico</label>
                    <input type="email" class="form-control mb-1" id="correo" name="correo" placeholder="ejemplo@correo.com" required>
                    <p id="msg_correo" class="mensaje-error-usr"></p>

                    <label class="form-label mt-2">Teléfono</label>
                    <input type="text" class="form-control mb-1" id="telefono" name="telefono" placeholder="Número de teléfono" required>
                    <p id="msg_telefono" class="mensaje-error-usr"></p>

                    <label class="form-label mt-2">Dirección</label>
                    <input type="text" class="form-control mb-1" id="direccion" name="direccion" placeholder="Dirección" required>
                    <p id="msg_direccion" class="mensaje-error-usr"></p>

                    <label class="form-label mt-2">Fecha de Nacimiento</label>
                    <input type="date" class="form-control mb-1" id="fecha_nacimiento" name="fecha_nacimiento" required>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <select class="form-select mb-1" id="tipoUsuario" name="tipo_usuario" onchange="toggleOpciones(this.value)" required>
                    ...
                    <div id="container_rol" class="mb-2 d-none">
                        ...
                        <select class="form-select mb-1" id="id_rol" name="id_rol" required>
                    ...
                    <div id="container_cargo" class="d-none">
                        ...
                        <select class="form-select mb-1" id="id_cargo" name="id_cargo" required>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label class="form-label mt-2">Rol</label>
                    <select class="form-select mb-1" id="id_rol_mod" name="id_rol" required></select>
                    <p id="msg_id_rol_mod" class="mensaje-error-usr"></p>
                    
                    <label class="form-label mt-2">Nombre</label>
                    <input type="text" class="form-control mb-1" id="nombre_mod" name="nombre" required>
                    <p id="msg_nombre_mod" class="mensaje-error-usr"></p>
                    
                    <label class="form-label mt-2">Apellido</label>
                    <input type="text" class="form-control mb-1" id="apellido_mod" name="apellido" required>
                    <p id="msg_apellido_mod" class="mensaje-error-usr"></p>
                    
                    <label class="form-label mt-2">Correo</label>
                    <input type="email" class="form-control mb-1" id="correo_mod" name="correo" required>
                    <p id="msg_correo_mod" class="mensaje-error-usr"></p>
                    
                    <label class="form-label mt-2">Teléfono</label>
                    <input type="text" class="form-control mb-1" id="telefono_mod" name="telefono" required>
                    <p id="msg_telefono_mod" class="mensaje-error-usr"></p>
                    
                    <label class="form-label mt-2">Dirección</label>
                    <input type="text" class="form-control mb-1" id="direccion_mod" name="direccion" required>
                    <p id="msg_direccion_mod" class="mensaje-error-usr"></p>
                    
                    <label class="form-label mt-2">Fecha de Nacimiento</label>
                    <input type="date" class="form-control mb-1" id="fecha_nacimiento_mod" name="fecha_nacimiento" required>
                    <p id="msg_fecha_nacimiento_mod" class="mensaje-error-usr"></p>
                    
                    <label class="form-label mt-2">Sexo</label>
                    <select class="form-select mb-1" id="sexo_mod" name="sexo" required>
                        <option value="">Seleccione...</option>
                        <option value="Masculino">Masculino</option>
                        <option value="Femenino">Femenino</option>
