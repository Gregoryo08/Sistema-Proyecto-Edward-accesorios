$(document).ready(function () {
  ...
  $("#cedulaModificar").keyup(function () {
    ...
    var cedula = prefijo + valor;
    var cedula_antigua = $("#id_empleado").val();
    ...
    if (valor.length == 0 && $("#prefijoModificar").val().length == 0) {
  ...
  $("#cargoModificar").change(function () {
    var valor = $(this).val();
    var expresion = /^[0-9]*$/;

    $("#texto_mensaje_cargo_modificar").css("display", "none");
    $("#texto_mensaje_cargo_modificar").text("");
    $(this).css("border", "1px solid #ced4da").css("box-shadow", "none");

    if (!expresion.test(valor)) {
      $("#texto_mensaje_cargo_modificar").css("display", "block");
      $("#texto_mensaje_cargo_modificar").text("El valor no es valido!");
  ...
  $("#pregunta1").keyup(function () {
    preguntas();
  });
  $("#pregunta2").keyup(function () {
    preguntas();
  });
  $("#pregunta3").keyup(function () {
    preguntas();
  });
