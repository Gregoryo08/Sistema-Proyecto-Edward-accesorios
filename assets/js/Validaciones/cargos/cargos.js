...
$(document).ready(function () {
  function validarCargoAntesDeConfirmar(id) {
    const $input = $(id);
    ...
    if (!valor) {
      ...
      $feedback.text("El nombre del cargo es obligatorio.").show();
      Swal.fire({
        title: "Nombre requerido",
        text: "Indique el nombre del cargo.",
        icon: "warning",
        color: "white",
        background: "#000910"
      });
  ...
  $("#registro").click(function () {
    if (validarCargoAntesDeConfirmar("#cargo")) {
  ...
  $("#modificar").click(function () {
    if (validarCargoAntesDeConfirmar("#cargo_modificar")) {
