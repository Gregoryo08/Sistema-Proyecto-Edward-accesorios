$(document).ready(function () {
  ...
  window.validarCategoriaAntesDeConfirmar = function (id) {
    const $input = $(id);
    ...
    if (!valor) {
      ...
      $feedback.text("El nombre de la categoría es obligatorio.").show();
      Swal.fire({
        title: "Nombre requerido",
        text: "Indique el nombre de la categoría.",
        icon: "warning",
        color: "white",
        background: "#000910"
      });
...
$(document).ready(function () {
  ...
  $("#registro").click(function () {
    if (validarCategoriaAntesDeConfirmar("#categoria")) {
  ...
  $("#modificar").click(function () {
    if (validarCategoriaAntesDeConfirmar("#categoria_modificar")) {
